...
const activities: Activity[] = [
    ...
    {name: 'Haver una casa de galleta navideña', completed: false},
    ...
    {name: 'Pintar una escena navideña', completed: false},
    ...
    {name: 'Dibujar un pato', completed: false},
    ...
    {name: 'Fotografiar un molino', completed: false},
    ...
    {name: 'Tomar un tranvía', completed: false},
    ...
    {name: 'Comer en la casa de Hansel y Gretel', completed: false},
    {name: 'Ganar un peluche en una feria', completed: false},
    {name: 'Comer macarrones', completed: false},
